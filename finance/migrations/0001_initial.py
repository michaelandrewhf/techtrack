    ...
    operations = [
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("amount__gte", 0)), name="agreement_amount_non_negative"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("billing_day__gte", 1), ("billing_day__lte", 31)),
                        name="agreement_billing_day_valid",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("ends_on__isnull", True), ("ends_on__gte", models.F("starts_on")), _connector="OR"
                        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("agreement", "Mensalidade/contrato"),
                ...
                (
                    "competence",
                    models.DateField(blank=True, help_text="Primeiro dia do mes de competencia.", null=True),
                ),
                ...
                (
                    "customer",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="receivables", to="customers.customer"
                    ),
                ),
                (
                    "service_agreement",
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("amount__gte", 0)), name="receivable_amount_non_negative"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("due_date__gte", models.F("issued_at"))), name="receivable_due_after_issue"
                    ),
                    models.UniqueConstraint(
                        condition=models.Q(("competence__isnull", False), ("service_agreement__isnull", False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_method",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="payments", to="catalog.paymentmethod"
                    ),
                ),
                (
                    "receivable",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="payments", to="finance.receivable"
                    ),
                ),
                (
                    "voided_by",
